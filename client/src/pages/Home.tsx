...
export default function Home() {
  ...
  const [digits, setDigits] = useState(4); // 자리수: 1~5
  const [increment, setIncrement] = useState(1); // 증가치: 1, 10, 100
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-slate-900 to-black flex flex-col items-center justify-center px-4 relative">
      ...
      {/* 설정 패널 */}
      {showSettings && (
        <div className="absolute top-24 right-6 bg-slate-800 rounded-2xl p-6 shadow-2xl z-50 w-80">
